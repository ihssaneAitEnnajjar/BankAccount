...
import org.sid.bankaccounts.mappers.AccountMapper;
...
public class AccountServiceImpl implements AccountService {
    ...
    public BankAccountResponseDTO addAccount(BankAccountRequestDTO bankAccountDTO) {
        BankAccount bankAccount =BankAccount.builder()
                ...
                .build();
        BankAccount saeBankAccount = bankAccountRepository.save(bankAccount);

        BankAccountResponseDTO bankAccountResponseDTO = accountMapper.fromBankAccount(saeBankAccount);
